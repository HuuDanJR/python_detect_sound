...
class _HomePageState extends State<HomePage> {
  final TextEditingController controllerTotalRound = TextEditingController(text: '${ConfigFactory.LIST_LENGTH}');
  final TextEditingController controllerTimeRound =TextEditingController(text: '${ConfigFactory.timer_duration_time}');
    ...
    //   child:
      Scaffold(
        ...
        AppBar(
                           ...
                           AlertDialog(
                                ...
                                content: SingleChildScrollView(
                                  child: Column(
                                    ...
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                      textcustom('+Total rounds: ${controllerTotalRound.text}',textTheme),
                                      textcustom('+Seconds/Round: ${controllerTimeRound.text}',textTheme),
                                      const Divider(),
                                      textcustom('Pick numbers to resume game', textTheme),
                                      const PickUpPage()
                                    ],
                                  ),
                                ),
                                actions: [
                                  ...
                                  TextButton(onPressed: (){
                                    HiveController().getSetting().then((v){
                                      print('setting get:${v!.roundInitial} ${v.timeDuration} ${v.totalRound}');
                                      HiveController().updateSetting(
                                        SettingModel(roundInitial: v!.roundInitial, timeDuration: int.parse(controllerTimeRound.text), totalRound: int.parse(controllerTotalRound.text))
                                      );
                                    });
                                ...
                                content: Column(
                                  ...
                                  children: [
                                    ...
                                    textcustom(
                                        ...
                                        textTheme),
                                    const Divider(),
                                    textcustom( 'Apply this setting for this game?',textTheme),
                                  ],
                                ),
                                actions: [
                                  TextButton(
                                  ...
                                  TextButton(
                                      onPressed: () {
                                        ...
                                        HiveController().getSetting().then((v){
                                         print('setting get:${v!.roundInitial} ${v.timeDuration} ${v.totalRound}');
                                          HiveController().updateSetting(
                                           SettingModel(roundInitial: [], timeDuration: int.parse(controllerTimeRound.text), totalRound: int.parse(controllerTotalRound.text))
                                          );
                                        });
          ...
          title: textCustomNormalColor( text: 'Bingo Game Settings', color: MyColor.white),
        ),
        body: SafeArea(
          child: Container(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        mytextfield(
                            ...
                            hint: "Round Time",
                            textInit:
                                '${ConfigFactory.timer_duration_time} seconds'),
                        const SizedBox(
                        ...
                        mytextfield(
                            ...
                            hint: "Total Round",
                            textInit: '${ConfigFactory.LIST_LENGTH} rounds'),
                      ],
                    ),
                  ),
                  textCustom(
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        textCustom(
                            color: MyColor.black_absulute,
                            text: "Switch to choose image or videos for banner"),
                      ],
                    ),
                  ),
                  ...
                  textCustom(text: "Video Banner", color: MyColor.black_text),
                  VideoDisplayPage(
                    socketManager: socket_manager,
                  ),
