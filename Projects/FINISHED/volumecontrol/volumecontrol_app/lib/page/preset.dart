                  ...
                  onTapLoading: () {
                    ...
                    showCustomAlertDialog(
                        ...
                        function: () {
                          ...
                          serviceAPIs.updatePresetVolumeAsCurrent(id: controllerGetX.preset.value!.id)
                          .then((value) => customSnackBar(context:context,message: value['message'])).whenComplete(() => Navigator.of(context).pop());
