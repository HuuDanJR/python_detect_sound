...
class MyGetXController extends GetxController {
  ...
  final RxList<Volume> volumesFloorPlan = <Volume>[].obs;
  @override
  void onInit() {
    super.onInit();
    listVolume();
  ...
  Future<void> fetchVolumesFloorPlan() async {
    try {
      ...
      debugPrint('fetchVolumes floorplan ${result.data.length}');
    } catch (e) {
      print('Error fetching floorplan volumes: $e');
    }
  }
      ...
      for (int i = 0; i < value.data.length; i++) {
        ...
        serviceAPIs.runDeviceFullURL(
            url: MyString.GET_DEVICE_API2(
                ...
                position: valueSliderAll.value*10));
      }
    });
  }
