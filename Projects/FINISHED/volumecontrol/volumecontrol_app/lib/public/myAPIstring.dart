class MyString {
  static const String ADRESS = "30.0.0.68";
  ...
  static String GET_DEVICE_API2({int? index, double? position}) {
    ...
    final url = '$BASE/potentiometer?potIndex=$index&sliderValue=$position_string';
    print('GET_DEVICE_API2 $url');
    print('GET_DEVICE_API2 $index ');
    return url;
  }
