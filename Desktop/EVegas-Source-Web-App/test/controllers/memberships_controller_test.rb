...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { name: @membership.name, point: @membership.point, sub: @membership.sub } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { name: @membership.name, point: @membership.point, sub: @membership.sub } }
