...
class IntroductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create introduction" do
    assert_difference('Introduction.count') do
      post introductions_url, params: { introduction: { description: @introduction.description, intro_index: @introduction.intro_index, title: @introduction.title } }
    end
  ...
  test "should update introduction" do
    patch introduction_url(@introduction), params: { introduction: { description: @introduction.description, intro_index: @introduction.intro_index, title: @introduction.title } }
